        ...
        <div class="animated fadeIn">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Title -->
              <h4 class="card-title"><a>Bienvenido {{Auth::user()->name}} <i class="fa fa-smile-beam fa-spin"></i>!</a></h4>
              <!-- Text -->
              <p class="card-text">Estas es un fase beta version 0.2 de la plataforma de Laboratorio.</p>
              <!-- Button -->
