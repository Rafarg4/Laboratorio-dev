                    ...
                    <div class="card-body">
                     ...
                     <div class="text-value-lg"><i class="cil-heart fa-2x"></i> <span class="badge badge-primary">
                       @if($recuperados == 0)
                        0
                        @else {
                     {{number_format((float)($recuperados*100)/$infectados,2, '.', '')}}% } @endif</span></div><small class="text-muted text-uppercase font-weight-bold"> Recuperados totales</small>
                      <div class="progress progress-xs mt-3 mb-0">
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="card">
                    <div class="card-body">
                     ...
                     <div class="text-value-lg"><i class="cil-sort-ascending fa-2x"></i> <span class="badge badge-dark">
                      @if($infectados == 0)
                        0
                        @else {
                     {{number_format((float)($infectados*100)/$caso_positivos,2, '.', '')}}% } @endif</span></div><small class="text-muted text-uppercase font-weight-bold"> Porcentaje de Infectados</small>
                      <div class="progress progress-xs mt-3 mb-0">
